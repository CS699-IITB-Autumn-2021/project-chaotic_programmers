# Generated by Django 3.2.7 on 2021-10-22 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relations', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('flashdeck', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.flashdeck')),
